    ...
    <>
      <Menu as="div" className={styles.menuWrapper}>
        <Menu.Button className={utilStyles.contents}>
          <RippleButton as="div" className={styles.iconButton}>
        ...
        <Menu.Items className={styles.menuItems}>
          <Menu.Item>
            {({ active }) => (
              <RippleButton as='button' onClick={() => {dispatch(changeAddDialog(true))}} className={styles.menuItem}>
                Add activity
              </RippleButton>
            )}
          </Menu.Item>
          <Menu.Item >
            {({ active }) => (
              <RippleButton as='button' onClick={() => {}} className={styles.menuItem}>
                Options
              </RippleButton>
            )}
          </Menu.Item>
